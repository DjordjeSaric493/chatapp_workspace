...
--
-- Class ChannelMember as table channel_member
--
...
--
-- Foreign relations for "channel_member" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('chatapp', '20260201163713856', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260201163713856', "timestamp" = now();
